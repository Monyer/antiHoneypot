...
var injectEnd = function() {
  window.addEventListener("load", function() {
    ...
    (function(){
        var lists = [
            {
                ...
                selector: "link",
                keyhtml: '<link rel="shortcut icon" type="image/png" href="../../assets/favicon-7901bd695fb93edb07975966062049829afb56cf11511236e61bcf425070e36e.png" id="favicon" data-original-href="/assets/favicon-7901bd695fb93edb07975966062049829afb56cf11511236e61bcf425070e36e.png">',
            },
            {
                type: "IIS Honeypot",
                title: "IIS Windows",
            ...
            },
            {
                ...
                selector: "link",
                keyhtml: '<link rel="bookmark" href="/wps/poc/!ut/p/digest!N_5daMHgbyRiOPvt7gua6g/nm/oid:6_CGAH47L00O2V002N5SQ0US30M1" title="Login" hreflang="en">'
            },
            {
                type: "Oracle WebLogic Honeypot",
                title: "Oracle WebLogic Server 管理控制台",
                selector: "link",
                keyhtml: '<link rel="stylesheet" type="text/css" href="./general.css">'
            },
            {
            ...
            },
            {
                ...
                keyhtml: '<input type="hidden" name="destination" value="https://owa.yuhong.com.cn/owa">',
            },
            {
            ...
            },
            {
                ...
                keyhtml: '<input type="hidden" id="rndData" name="rndData" value="803350804370334">',
            },
            {
                type: "Jira Honeypot",
                title: "登录 - Jira",
                selector: 'form[class="aui"]',
                keyhtml: '<form action="/login" class="aui" id="login-form" method="post">',
            },
            {
                type: "Confluence Honeypot",
                title: "Log In - Confluence",
                selector: 'form[name="loginform"]',
                keyhtml: '<form name="loginform" method="POST" action="login" class="aui login-form-container">',
            },
            {
            ...
            },
            {
                ...
                selector: 'form',
                keyhtml: '<form class="form-signin session_login clearfix" action="login" method="post" role="form" onsubmit="spinner()">',
            },
            {
            ...
            },
            {
                ...
                keyhtml: '<div ext:qtip="DSM-Host" id="sds-login-dialog-title">DSM-Host</div>',
            },
            {
                type: "HFish Honeypot",
                title: "Login",
        ...
        lists.forEach(one=>{
            if (document.title.includes(one.title)
            && document.querySelector(one.selector).outerHTML.includes(one.keyhtml)
            ) {
                window.top.postMessage({
                    msgType: "hfish",
                    msgData: one.type
